...
import { getButterflyChartOption } from './saleStockUpData'
import type { SaleStockUpDetail, SaleStockUpSummary } from '@/api/sale/types'
...
// 选择的排序字段
const sortField = ref<SortField>('forecastQty')
// 选择的排序方向
  ...
  <div class="chart-wrapper" :class="{ 'detail-chart': props.type === 'detail' }">
    <div class="chart-controls">
      ...
      <div class="control-area">
        ...
        >
          <ElOption label="完成率" value="completeRate" />
          <ElOption label="预测销量" value="forecastQty" />
          <ElOption label="实际销量" value="actualQty" />
        </ElSelect>
      </div>
    </div>
