...
import { SaleStockUpDetail } from '@/api/sale/types'
...
const props = defineProps({
  tableData: {
    type: Array as PropType<SaleStockUpDetail[]>,
    default: () => []
  },
  enableSelection: {
    type: Boolean,
...
<template>
  ...
  >
    ...
    >
      ...
      <div class="flex-1 text-center">备货计划和实际对比详情</div>
    ...
    <ElTable :data="tableData" border class="flex-1" highlight-current-row>
      <!-- 数据列 -->
